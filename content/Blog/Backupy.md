...
Któregoś dnia, dysk w tym latopie po prostu padł.
...
Pomysł jest bardzo dobry, serwer ma być **lokalny** więc nie ma konieczności wystawiania go po za sieć lokalną... mieści się w normie bezpiecznego projektu do nauki. Serwer może mieć firewall bardzo restrykcyjny (deny incoming, deny outgoing) i jedynie zezwalać na połączenia z repozytorium programów OS'a który serwer używa. Szczerze? FreeBSD wydaje się świetnym wyborem na serwer ale waham się. Jest dużo za.
